...
with col3:
    ...
    def style_table(df):
        return df.style.set_table_styles(
            [
                {"selector": "thead th", "props": [("background-color", "white"), ("color", "black"), ("font-weight", "bold")]},  # Header styling
                {"selector": "tbody td", "props": [("background-color", "#f9f9f9"), ("color", "black")]},  # Cell styling
